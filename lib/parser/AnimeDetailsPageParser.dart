...
class AnimeDetailsPageParser {
  ...
  Map<String, dynamic> parseAnimeDetailsPage(String page){
    ...
    if (page!= null || page.isNotEmpty){
      ...
      var imageUrl = doc.getElementById( _AnimeDetailsPageNames.ID_ANIME_COVER)
      ...
      var episodesItemList = container[0].children.map< Map<String, dynamic> >(
              (anchor) {
  ...
  String _parseAnimeTitle(Element body){
    return body.getElementsByClassName(_AnimeDetailsPageNames.TITLE_ELEMENT)
        [0].getElementsByTagName('h1')[0].text;
  }

  Map<String, dynamic> _parseAnimeInfo(Element infoContainer){
    var infoChildren = infoContainer.getElementsByClassName(
        _AnimeDetailsPageNames.ANIME_BOX_INFO);
